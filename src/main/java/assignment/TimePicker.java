...
public class TimePicker extends TextField {
    ...
    public TimePicker(String time) {
        ...
        hours.bind(new TimePicker.TimeUnitBinding(Unit.HOURS));
        minutes.bind(new TimePicker.TimeUnitBinding(Unit.MINUTES));
        seconds.bind(new TimePicker.TimeUnitBinding(Unit.SECONDS));
